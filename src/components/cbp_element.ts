...
import './cbp_element.scss';

/** Describes an html element used by CbpElements */
...
export abstract class CbpElement extends HTMLElement {
  protected html_string: string = '';
  fully_parsed = false;
  private els_metadata: ElementMetadata[] = [];

  async connectedCallback() {
    this.classList.add('cbp-element');
